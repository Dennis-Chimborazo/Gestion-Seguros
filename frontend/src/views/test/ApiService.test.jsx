...
describe('ApiService', () => {
  ...
  describe('traerDatos', () => {
    ...
    it('debe manejar errores de red', async () => {
      ...
      await expect(ApiService.traerDatos('ruta/fake', navigateMock)).rejects.toThrow('Network Error');
    });
    ...
    it('debe manejar respuestas null o undefined correctamente', async () => {
      ...
      const result1 = await ApiService.traerDatos('test/endpoint', navigateMock);
      ...
      const result2 = await ApiService.traerDatos('test/endpoint', navigateMock);
      ...
      const result3 = await ApiService.traerDatos('test/endpoint', navigateMock);
  ...
  describe('enviarDatos', () => {
    it('debe enviar datos correctamente', async () => {
      ...
      const result = await ApiService.enviarDatos('user/create', mockForm, navigateMock);
    ...
    it('debe manejar errores al enviar datos', async () => {
      ...
      await expect(ApiService.enviarDatos('user/create', mockForm, navigateMock)).rejects.toThrow('Server Error');
    });
    ...
    it('debe construir la URL correctamente', async () => {
      ...
      await ApiService.enviarDatos('api/endpoint', mockForm, navigateMock);
  ...
  describe('buscarDatos', () => {
    it('debe buscar datos con token válido', async () => {
      ...
      const result = await ApiService.buscarDatos('search/endpoint', 123, navigateMock);
    ...
    it('debe usar token vacío cuando no hay datos de login', async () => {
      ...
      const result = await ApiService.buscarDatos('search/endpoint', 456, navigateMock);
    ...
    it('debe manejar errores en búsqueda', async () => {
      ...
      await expect(ApiService.buscarDatos('search/endpoint', 123, navigateMock)).rejects.toThrow('Search failed');
    });
  });
  ...
  describe('actualizarDatos', () => {
    it('debe actualizar datos correctamente', async () => {
      ...
      const result = await ApiService.actualizarDatos('user/update', mockForm, navigateMock);
    ...
    it('debe manejar errores al actualizar', async () => {
      ...
      await expect(ApiService.actualizarDatos('user/update', mockForm, navigateMock)).rejects.toThrow('Update failed');
    });
  });
  ...
  describe('borrarDatos', () => {
    it('debe borrar datos correctamente', async () => {
      ...
      const result = await ApiService.borrarDatos('user/delete', mockForm);
    ...
    it('debe manejar errores al borrar', async () => {
      ...
      await expect(ApiService.borrarDatos('user/delete', mockForm)).rejects.toThrow('Delete failed');
    });
  });
