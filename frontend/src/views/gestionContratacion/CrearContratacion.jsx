...
export function CrearContratacion({ mostrarSeccion }) {
  ...
  const [empleado, setEmpleado] = useState({ id_emple: '', nom_emple: '', email_emple: '' });
  ...
  const buscarEmpleado = async (e) => {
    ...
    if (id !== '') {
      const res = await GestionContratacionFun.buscarEmpleado(id, navigate);
      if (res.length == 0) {
        toast.error("Empleado no encontrado ⚠️");
        setNuevoSeguro({ ...nuevoSeguro, id_emple: '' })
        setEmpleado({ ...empleado, nom_emple: '', email_emple: '' })
      } else {
        setNuevoSeguro({ ...nuevoSeguro, id_emple: res[0].id_emple })
        setEmpleado({ ...empleado, id_emple: res[0].id_emple, nom_emple: res[0].nom_emple, email_emple: res[0].email_emple })
      }
    } else {
    ...
    <div>
      <form action="" method="">
          ...
          <div>
            ...
            <div>
              <div>
                ...
                <label htmlFor="nom_cuent_Ban">Banco</label>
                <input
                  type="text"
                  name="nom_cuent_Ban"
                  id="nom_cuent_Ban"
                ...
                <label htmlFor="mun_cuent_Ban">Cuenta No.</label>
                <input
                  type="text"
                  name="mun_cuent_Ban"
                  id="mun_cuent_Ban"
        ...
        <div>
          ...
          <button onClick={guardarSeguro}>Nueva Contratacion</button>
